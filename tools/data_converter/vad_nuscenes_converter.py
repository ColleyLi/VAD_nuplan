...
def _fill_trainval_infos(nusc,
    ...
    for sample in mmcv.track_iter_progress(nusc.sample):
        ...
        # print("info[lidar2ego_translation]", info["lidar2ego_translation"])
        # print("info[lidar2ego_rotation]", info["lidar2ego_rotation"])
        ...
        if not test:
            ...
            # print("NuScenesDataset.NameMapping", NuScenesDataset.NameMapping)
            ...
            print("info['gt_ego_lcf_feat']",info['gt_ego_lcf_feat'])
            # print("info['gt_agent_fut_masks']",info['gt_agent_fut_masks'])
...
def obtain_sensor2top(nusc,
    ...
    # print("sensor2ego_translation",  cs_record['translation'])
    # print("sensor2ego_rotaion",  cs_record['rotation'])
    sweep = {
        'data_path': data_path,
        'type': sensor_type,
    ...
    # print("l2e_r_s_mat", l2e_r_s_mat)
    # print("e2g_r_s_mat", e2g_r_s_mat)
    
    # print("e2g_r_mat", e2g_r_mat)
    ...
    # print("sweep['sensor2lidar_translation']", sweep['sensor2lidar_translation'])
    # print("sweep['sensor2lidar_rotation']", sweep['sensor2lidar_rotation'])
    
    fx_l2e_r_s_mat = np.linalg.inv(e2g_r_s_mat) @ e2g_r_mat @  l2e_r_mat @ sweep['sensor2lidar_rotation']
    # print("fx_l2e_r_s_mat_error", fx_l2e_r_s_mat - l2e_r_s_mat)
    ...
    # print("type_fx_l2e_r_s", type(fx_l2e_r_s))
    
    # scalar_part = fx_l2e_r_s.scalar 
    # vector_part = fx_l2e_r_s.vector
    # fx_l2e_r_s = [-scalar_part] + list(-vector_part)
    
    # print("fx_l2e_r_s", fx_l2e_r_s)
    # print("l2e_r_s", l2e_r_s)


    # print("fx_l2e_r_s_error", np.array(fx_l2e_r_s) - np.array(l2e_r_s))
    ...
    # print("fx_l2e_t_s_error", np.array(fx_l2e_t_s) - np.array(l2e_t_s))
...
parser.add_argument('dataset', metavar='nuscenes', default='nuscenes', help='name of the dataset')
parser.add_argument(
    '--root-path',
    type=str,
    default='/data/zyp/Projects/VAD1/VAD-main/data/nuscenes',
    help='specify the root path of dataset')
parser.add_argument(
    '--canbus',
    type=str,
    default='/data/zyp/Projects/VAD1/VAD-main/data',
...
parser.add_argument('--extra-tag', type=str, default='vad_nuscenes')
parser.add_argument(
