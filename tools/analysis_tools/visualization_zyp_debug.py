...
if __name__ == '__main__':
    ...
    # 我print过发现这里的 len(sample_token_list) 为 6019
    for id in tqdm(range(60)): # len(sample_token_list)
        ...
        print("current_token_name", sample_token_list[id])
        ...
        save_path = osp.join(out_path, 'without_plan', f'bev_pred_{id}.png')  # 替换为你想保存的文件路径
